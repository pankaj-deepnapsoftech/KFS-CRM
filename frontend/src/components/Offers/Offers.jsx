                              ...
                              return (
                                <Td fontWeight="600" {...cell.getCellProps()}>
                                  {cell.column.id !== "number" &&
                                    ...
                                    cell.render("Cell")}
                                  {cell.column.id === "lead" && row.original?.lead  && (
                                    <span>
                                  ...
                                  {cell.column.id === "lead" && row.original?.indiamartlead  && (
                                    <span>
                                      {row.original?.indiamartlead && row.original.indiamartlead?.company
                                        ? row.original.indiamartlead?.company.companyname
                                        : row.original.indiamartlead?.people.firstname +
                                          " " +
                                          (row.original.indiamartlead?.people?.lastname || '')}
                                    </span>
                                  )}
                                  {cell.column.id === "number" && (
                                    <span>{ind + 1}</span>
